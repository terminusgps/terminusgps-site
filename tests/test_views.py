...
class HomeViewTestCase(TestCase):
    ...
    def test_cache_control_header(self):
        """Fails if ``max-age=300`` wasn't present in the ``Cache-Control`` response header."""
        response = self.client.get(self.uri)
...
class ContactFormViewTestCase(TestCase):
    ...
    def test_post_with_valid_data_saves_and_redirects(self):
        ...
        response = self.client.post(self.uri, data=valid_data)
    ...
    def test_post_with_valid_data_triggers_admin_email(self):
        ...
        with mock.patch(
            ...
            self.client.post(self.uri, data=valid_data)
...
class ContactFormSuccessViewTestCase(TestCase):
    def setUp(self):
        self.uri = reverse("contact form success")
        self.client = Client()
